/**
 * Purpose: Peers route error boundary — catches render errors within peers layout
 */
'use client';

import { Button } from '@/components/ui';

export default function PeersError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
