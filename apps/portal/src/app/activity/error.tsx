/**
 * Purpose: Activity route error boundary — catches render errors within activity layout
 */
'use client';
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center" data-testid="error-boundary">
      ...
      <p className="text-sm text-text-secondary mb-6 max-w-md">
        An unexpected error occurred loading the activity page. Try reloading, or head back to the home page.
      </p>
